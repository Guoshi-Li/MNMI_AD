...
% FLAG = 1; % 1: NC vs. AD; 2: NC vs MCI; 3: MCI vs AD
...
CN = NP;
NP = 2*NR+1+CN;  % Number of parameters
...
MMSE_ALL  = [CDR_NC; CDR_MCI; CDR_AD];
...
disp('Correlation between Intra-regional E-I difference and CDR:')
...
disp('The regions that pass FDR correction are:')
k1'
...
disp('Correlation between Intra-regional E/I ratio and CDR:')
...
fprintf('\n')
disp('Correlation between Inter-regional E-I difference and CDR:')
...
fprintf('\n')
disp('Correlation between Total E-I difference and CDR:')
...
fprintf('\n')
disp('Correlation between Total E/I ratio and CDR:')
...
EI16_T = W_TOTAL_ALL(:,16);
EI38_T = W_TOTAL_ALL(:,38);
EI40_T = W_TOTAL_ALL(:,40);
EI41_T = W_TOTAL_ALL(:,41);

TOTAL_RATIO_EI16 = W_RATIO_ALL(:,16);
TOTAL_RATIO_EI21 = W_RATIO_ALL(:,21);
TOTAL_RATIO_EI38 = W_RATIO_ALL(:,38);
TOTAL_RATIO_EI40 = W_RATIO_ALL(:,40);
TOTAL_RATIO_EI41 = W_RATIO_ALL(:,41);

% Correlation using total E-I difference

figure;
scatter(EI16_T, MMSE_ALL,'LineWidth',1);
axis([-8, 8, -0.5, 8]);
set(gca, 'XTick', [-8:4:8])
h1 = lsline();
h1.LineWidth = 2;
h1.Color = 'r';
set(gca, 'FontSize', 16);
title('R.PCC', 'FontSize', 18);
xlabel('Total E-I Diff.');
ylabel('CDR Score');
txt1 = [ 'r = 0.25' ];
txt2 = ['p* = 0.03' ];
text(4, 7, txt1, 'FontSize', 18, 'Color', 'r');
text(4, 6, txt2, 'FontSize', 18, 'Color', 'r');
...
figure;
scatter(EI40_T, MMSE_ALL,'LineWidth',1);
axis([-6, 6, -0.5, 8]);
set(gca, 'XTick', [-6:3:6])
h1 = lsline();
h1.LineWidth = 2;
h1.Color = 'r';
set(gca, 'FontSize', 16);
title('R.PAL', 'FontSize', 18);
xlabel('Total E-I Diff.');
ylabel('CDR Score');
txt1 = [ 'r = -0.27' ];
txt2 = ['p* = 0.019' ];
text(3, 7, txt1, 'FontSize', 18, 'Color', 'r');
text(3, 6, txt2, 'FontSize', 18, 'Color', 'r');
...
figure;
scatter(TOTAL_RATIO_EI16, MMSE_ALL,'LineWidth',1);
axis([0, 3, -0.5, 8]);
h1 = lsline();
h1.LineWidth = 2;
h1.Color = 'r';
...
txt1 = [ 'r = 0.26' ];
txt2 = ['p* = 0.03' ];
text(2.2, 7, txt1, 'FontSize', 18, 'Color', 'r');
text(2.2, 6, txt2, 'FontSize', 18, 'Color', 'r');

figure;
scatter(TOTAL_RATIO_EI21, MMSE_ALL,'LineWidth',1);
axis([0, 3, -0.5, 8]);
h1 = lsline();
h1.LineWidth = 2;
h1.Color = 'r';
...
figure;
scatter(TOTAL_RATIO_EI38, MMSE_ALL,'LineWidth',1);
axis([0, 3, -0.5, 8]);
h1 = lsline();
h1.LineWidth = 2;
h1.Color = 'r';
...
figure;
scatter(TOTAL_RATIO_EI40, MMSE_ALL,'LineWidth',1);
axis([0, 3, -0.5, 8]);
h1 = lsline();
h1.LineWidth = 2;
h1.Color = 'r';
