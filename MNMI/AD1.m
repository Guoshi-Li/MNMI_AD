...
% This code estimates the parameters for AD subject 1 (AD1)
% For AD subject i, just change "AD1" to "ADi" for the "Subject" variable
...
% This code estimates the parameters for AD 1 (AD1)
% For AD subject i, just change "AD1" to "ADi" for "Subject" 
